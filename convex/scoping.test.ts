...
describe('coverage', () => {
  ...
  const EXEMPT = new Map([
    ...
    // The MAR. Cross-building refusals are exercised in medications.test.ts.
    ['medications:board', 'resolveBuilding'], ['medications:forResident', 'scopedTenant'],
    ['medications:shift', 'resolveBuilding'], ['medications:change', 'scoped order'],
    ['medications:sheet', 'scopedTenant'], ['medications:add', 'scoped tenant'],
    ['medications:update', 'scoped order'], ['medications:discontinue', 'scoped order'],
    ['medications:administer', 'scoped order'], ['medications:voidEntry', 'scoped entry'],
    ...
    ['shiftReports:mine', 'keyed on the caller: by_author_date on requireStaff, nothing is taken from args'],
